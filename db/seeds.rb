...
# trip_2 = user.trips.create!(seats_available: 3, vehicle_id: 1, rtd_location_id: 4, destination_point: "Breckenridge", date_of_departure: "Dec 4 2019", ride_type: "one-way")
